                ...
                if not edit_prompt.strip():
                    ...
                    try:
                        ...
                        if not api_key:
                            ...
                            print(f"Editing with prompt: {edit_prompt}")
                            ...
                            if not payload.get("data"):
                                ...
                                if eimg is None:
                                    ...
                                    # st.session_state.images["org"] = img
                                    low, med, high = (
                                        PostProcessing.apply_post_processing(eimg)
                                    )
                                    st.session_state.images["low"] = low
                                    st.session_state.images["medium"] = med
                                    st.session_state.images["high"] = high
                    ...
                    #                 # Streamlit will rerun; LEFT reads session_state and shows the selected level instantly.
